...
PUBLIC_KEY_FILE=/path/to/key.publickey
PRIVATE_KEY_FILE=/path/to/key.privatekey
...
BASE_INSTALLER_DIRECTORY=/var/www/dist/installers/base

BASE_INSTALLER_ARCHIVE_DIR=/v/www/dist/installers/base/old_base_installers
